    ...
    <header className="relative isolate z-10 bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex">
          <Popover>
            <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 px-5">
              Product
          ...
          <a href="#" className="px-5 text-sm font-semibold leading-6 text-gray-900">
            Features
          </a>
          <a href="#" className="px-5 text-sm font-semibold leading-6 text-gray-900">
            Marketplace
          ...
          <a href="#" className="px-5 text-sm font-semibold leading-6 text-gray-900">
            Company
          </a><a href="#" className="px-5 text-sm font-semibold leading-6 text-gray-900">
            Company
          </a>
