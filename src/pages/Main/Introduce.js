    ...
    <div className="flex justify-between">
        <div>
            <div className="introduce1 w-[496px] h-[692px] px-[36px] pb-[63px] text-left flex flex-col flex-start justify-end text-white">
                ...
                <a><div className="w-[162px] h-[57px] border-2 border-white border-opacity-30 rounded-[28px] flex justify-center items-center hover:bg-white text-[18px] font-medium hover:bg-[#1035D1] hover:border-opacity-0 cursor-pointer">학과 바로가기</div></a>
            </div>
        </div>
        <div>
